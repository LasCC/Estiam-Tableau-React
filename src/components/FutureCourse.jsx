...
export default function FutureCourse() {
    return (
        <div>
            <h4 className="text-italic mt-4">Prochain cours : </h4>
            <div className="container">
                <section id="past">
                    <div className="col-md-11 mx-auto">
                        <div className="container card mt-3" id="pasttuile">
                            <div className="card-body d-flex bd-highlight" id="pastcontent">
                                <div className="bd-highlight align-self-center"><span className="btn btn-info justify-content-start m-2" id="ects-badge">ECTS</span></div>
